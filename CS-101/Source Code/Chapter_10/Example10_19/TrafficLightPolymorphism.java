...
public class TrafficLightPolymorphism extends Application
{
   ...
   public void start( Stage stage ) 
   {
     ...
     figuresList.add( new Square( SQUARE_X, SQUARE_Y, 
                                  Color.BLACK, SQUARE_SIZE ) );
     figuresList.add( new Square( SQUARE_X, SQUARE_Y + SQUARE_SIZE, 
                                  Color.BLACK, SQUARE_SIZE ) );
     figuresList.add( new Square( SQUARE_X, SQUARE_Y + ( SQUARE_SIZE * 2 ), 
                                  Color.BLACK, SQUARE_SIZE ) );

     figuresList.add( new Circle( CIRCLE_X, CIRCLE_Y, 
                                  Color.RED, CIRCLE_RADIUS ) );
     figuresList.add( new Circle( CIRCLE_X, CIRCLE_Y + SQUARE_SIZE, 
                                  Color.YELLOW, CIRCLE_RADIUS ) );
     figuresList.add( new Circle( CIRCLE_X, CIRCLE_Y + ( SQUARE_SIZE * 2 ), 
