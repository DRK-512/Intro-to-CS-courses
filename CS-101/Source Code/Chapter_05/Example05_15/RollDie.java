    ...
    public void start( Stage stage ) 
    {
       ...
       switch ( roll )
       {
          case 5: // draw upper right and lower left dots
           gc.fillOval( START_X + DOT_3, START_Y + DOT_1,
                        DOT_SIZE, DOT_SIZE );
           gc.fillOval( START_X + DOT_1, START_Y + DOT_3,
                         DOT_SIZE, DOT_SIZE ); 
          case 3: // draw upper left and lower right dots
           gc.fillOval( START_X + DOT_1, START_Y + DOT_1,
                        DOT_SIZE, DOT_SIZE );
           gc.fillOval( START_X + DOT_3, START_Y + DOT_3,
                         DOT_SIZE, DOT_SIZE ); 
          case 1: // draw center dot
           gc.fillOval( START_X + DOT_2, START_Y + DOT_2,
                        DOT_SIZE, DOT_SIZE );
           break; // stop executing the switch

          case 6: // draw middle left and right dots
           gc.fillOval( START_X + DOT_1, START_Y + DOT_2,
                        DOT_SIZE, DOT_SIZE );
           gc.fillOval( START_X + DOT_3, START_Y + DOT_2,
                         DOT_SIZE, DOT_SIZE ); 
