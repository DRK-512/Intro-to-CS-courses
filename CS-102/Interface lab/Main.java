...
* Date: 4/7/2021
* Question number: 2
* Description: This main class is used to test the package made for the interfaces by creating Product objects from each class
*/

import KonopkaOnlineShopUsingInterface.*;
